<template>
  <div class="min-h-[calc(100vh-120px)]" style="background:#FAFAF7;">
    ...
    <div class="fav-hero">
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <nav class="flex items-center gap-2 text-sm mb-4" style="color:#A8A8A8;">
          ...
          <span>/</span>
          <span style="color:#1A1A1A;">Favorites</span>
        </nav>
        <h1 class="text-3xl sm:text-4xl font-bold" style="color:#1A1A1A;">My Favorites</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div v-if="favoritesStore.items.length === 0" class="text-center py-24">
        ...
        <h2 class="text-xl font-bold mb-2" style="color:#1A1A1A;">No favorites yet</h2>
    ...
    <Transition name="fade">
      <div v-if="confirmClear"
        ...
        <div class="bg-white rounded-2xl p-6 max-w-sm w-full shadow-xl">
          <h3 class="text-base font-bold mb-1" style="color:#1A1A1A;">Clear all favorites?</h3>
          <p class="text-sm mb-5" style="color:#6B6B6B;">This will remove all your saved items.</p>
          <div class="flex gap-3">
            <button @click="confirmClear = false"
              class="flex-1 py-2.5 rounded-xl text-sm font-semibold border transition-colors"
              style="border-color:#E4E0D8;color:#3F3F3F;">
              Cancel
            </button>
